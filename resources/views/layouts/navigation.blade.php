    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6 items-center">
                <a href="/cart" class="bg-indigo-500 text-white py-1 px-2 text-sm rounded-lg">View cart <i class="lni lni-cart"></i></a>
                <div class='text-sm font-bold text-gray-500 mx-3'>RM{{Auth::user()->total_cart_price ?? 0 }}</div>
